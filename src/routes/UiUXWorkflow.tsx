  ...
  const webServices = [
    {
      ...
      title: "Web Design",
      description:
        "We craft visually stunning and strategically effective websites that capture your brand's unique identity and captivate your audience from the first click.",
      color: "bg-lime-400",
    },
    {
      icon: ShoppingCart,
      title: "ECommerce",
      description:
        "Transform your online store into a powerful sales engine with intuitive product discovery, seamless checkout flows, and a shopping experience built for conversion.",
      color: "bg-lime-400",
    },
    {
      icon: Heart,
      title: "UX Design",
      description:
        "Our user-centered approach focuses on creating intuitive, efficient, and enjoyable journeys that keep users engaged and coming back for more.",
      color: "bg-lime-400",
    },
    {
      icon: Smartphone,
      title: "Responsive",
      description:
        "Your website will provide a flawless experience on any device, from desktops to smartphones, ensuring you reach and engage every customer.",
      color: "bg-lime-400",
    },
    {
      icon: FileText,
      title: "Wireframes",
      description:
        "We build clear, structural blueprints to strategically map out user journeys and functionality, establishing a solid foundation before visual design begins.",
      color: "bg-lime-400",
    },
    {
      icon: Target,
      title: "Strategy",
      description:
        "We go beyond aesthetics by defining clear goals, understanding your audience, and aligning your website's design with your overarching business objectives.",
      color: "bg-lime-400",
    },
  ];
            ...
            <div className="px-8 pt-8 pb-4">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-gray-600 leading-relaxed">
                  <p className="mb-6">
                    We believe great design goes beyond visuals—it's about
                    creating smooth, meaningful interactions. By blending
                    creativity with strategy, we ensure every project not only
                    looks stunning but also provides an effortless user journey.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-8 pb-8">
              ...
              <div className="mb-12">
                <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  Our Manchester-based UI/UX design studio is committed to
                  transforming ideas into digital experiences that truly connect
                  with people. We begin every project by understanding user
                  behavior, business objectives, and market trends to ensure the
                  foundation is strong. From research and wireframing to
                  prototyping and usability testing, our process is designed to
                  create intuitive and visually compelling interfaces. Each
                  design is carefully crafted to provide seamless navigation,
                  consistent branding, and accessibility across all devices. By
                  blending creativity with strategy, we deliver solutions that
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl relative">
                ...
                <img
                  ...
                  className="w-full h-full min-h-[400px] md:min-h-0 object-cover transform transition-transform duration-[2000ms] ease-in-out hover:scale-110 block"
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Effective requirement gathering is the foundation of any
                    successful project. It involves in-depth discussions with
                    stakeholders to identify business objectives, user needs,
                    and functional expectations. This phase ensures that the
                    final product aligns with the client's vision and delivers
                ...
                <div className="relative overflow-hidden rounded-2xl group cursor-pointer">
                  <div className="aspect-[4/3] min-h-[400px] md:min-h-0 relative">
                    {/* First (default) image */}
                    <div className="absolute inset-0">
                      <img
                        src={uiuxWorkflow2ndImg}
                        alt="Team meeting discussing client goals"
                        className="w-full h-full min-h-[400px] md:min-h-0 object-fit rounded-2xl transition-opacity duration-0 group-hover:opacity-0 group-hover:delay-0 delay-700"
                      />
                    </div>
                    ...
                    <div className="absolute inset-0 transform -translate-x-full translate-y-full group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-700 ease-out">
                      <img
                        src={uiuxWorkflow2ndImg}
                        alt="Team meeting discussing client goals"
                        className="w-full h-full min-h-[400px] md:min-h-0 object-fit rounded-2xl"
                      />
                    </div>
            ...
            <div className="px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Through research and analysis are critical for making
                    informed design decisions. This phase involves a deep dive
                    into the market landscape to understand competitor strengths
                    and weaknesses, creating detailed profiles of target users,
                    and identifying current and emerging design trends to ensure
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    ...
                    architecture. It involves creating a clear sitemap outlining
                    all pages and content sections, designing intuitive
                    navigation systems for seamless user experience, and mapping
                    the content flow to ensure users can complete their tasks
                    efficiently and find information without friction.
                  </p>
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-stretch">
                ...
                <div className=" rounded-2xl p-8 relative overflow-hidden">
                  ...
                  <p className="text-gray-300 leading-relaxed mb-8 text-sm text-center">
                    Low-fidelity layouts, such as wireframes, are used to
                    establish the basic structure and layout of key screens
                    without visual design details. This allows the team to focus
                    on functionality, user flow, and element placement ensuring
                    a solid foundational experience before investing in visual
                    design and content.
                  </p>
                ...
                <div className="rounded-2xl p-8 container relative overflow-hidden">
                  ...
                  {/* Description */}
                  <p className="text-gray-300 leading-relaxed mb-8 text-sm text-center">
                    Mapping user journeys is essential for creating an intuitive
                    experience. This process involves outlining the step-by-step
                    paths users will take to complete key tasks, identifying
                    potential pain points, and ensuring the navigation is
                    logical and efficient. This helps in creating a seamless
                    flow that guides users effortlessly to their goals.
                  </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="px-8 pt-8 pb-4">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="text-gray-600 leading-relaxed">
                  <p className="mb-6">
                    Clickable mid and high-fidelity prototypes transform static
                    designs into dynamic, interactive models that closely mimic
                    the final product. They are essential for validating complex
                    user flows, conducting effective usability testing to gather
                    actionable feedback, and clearly communicating the intended
                    functionality and experience to stakeholders and developers
                    before committing to costly development.{" "}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Our visual design process translates your brand's essence
                    into a compelling and intuitive user interface. We craft
                    pixel-perfect experiences by meticulously defining the core
                    elements that users see and interact with. This includes
                    establishing a cohesive color palette that reflects your
                    brand identity and guides user behavior, selecting
                    typography that ensures readability and personality, and
                    building a robust library of reusable UI components.
                  </p>
            ...
            <div className="px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Usability testing is a crucial step that places your design
                    directly in front of real users to identify pain points,
                    uncover opportunities, and validate design decisions before
                    launch. We facilitate structured tests where participants
                    complete specific tasks while we observe their behavior,
                    gather their feedback, and measure key metrics like success
                    rates and task time.
                  </p>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-24">
            ...
            <div className="text-center mb-16 lg:mb-20">
              ...
              <h1 className="text-4xl md:text-5xl text-white lg:text-6xl xl:text-7xl font-bold leading-tight max-w-5xl mx-auto">
                A Team Of Web Design Experts That Can Help You Design And Build
              ...
              {webServices.map((service, index) => (
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    <div
                      className={`flex-shrink-0 w-12 h-12 ${service.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
            ...
            <div className="text-center mb-16 flex justify-center">
              <div className="hidden items-center gap-3 md:flex relative ">
                ...
                <img
                  src="/Arrow 1-1.svg"
                  alt="arrow"
                  className="p-4 rounded-full bg-lime-300 text-brand-ink absolute left-40 "
                />
              </div>
            </div>
          </div>
            ...
            <div className="px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed mb-8">
                    True design excellence is achieved through a cycle of
                    creation, feedback, and refinement. We systematically gather
                    and analyze input from users and stakeholders to identify
                    key areas for enhancement. This iterative process ensures
                    the final product is not only beautiful but also highly
                    functional, intuitive, and perfectly aligned with both user
